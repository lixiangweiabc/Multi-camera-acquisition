...
_MV_CC_FRAME_SPEC_INFO_._fields_ =[
    ('nSecondCount', c_uint),      #unsigned int --- c_uint
    ('nCycleCont', c_uint),
    ('nCycleOffset', c_uint),
    ('fGain', c_float),             #float --- c_float
    ...
    ('nInput', c_uint),
    ('nOutput', c_uint),
    ('nOffsetX', c_ushort),         #short --- c_ushort
    ('nOffsetY', c_ushort),
...
#添加解压结构
class _MV_CC_HB_DECODE_PARAM_(Structure):
    pass
_MV_CC_HB_DECODE_PARAM_._fields_ = [
    ('pSrcBuf', POINTER(c_ubyte)),         #unsigned char* --- POINTER(c_ubyte)
    ('nSrcLen', c_uint),
    ('nWidth', c_uint),
    ('nHeight', c_uint),
    ...
    ('nDstBufSize', c_uint),
    ('nDstBufLen', c_uint),
    ('enDstPixelType', MvGvspPixelType),   # 像素格式
    ('stFrameSpecInfo', MV_CC_FRAME_SPEC_INFO),  # 水印信息
    ('nRes', c_uint*8),
]
MV_CC_HB_DECODE_PARAM = _MV_CC_HB_DECODE_PARAM_
...
__all__ = ['_MV_ALL_MATCH_INFO_', 'MV_CC_FILE_ACCESS_PROGRESS',
           ...
           '_MV_CC_FRAME_SPEC_INFO_', '_MV_CC_HB_DECODE_PARAM_', 'MV_CC_FRAME_SPEC_INFO', 'MV_CC_HB_DECODE_PARAM']
