...
class MvCamera():
    ...
    def MV_CC_HB_Decode(self, stDecodeParam):
        MvCamCtrldll.MV_CC_GetImageBuffer.argtype = (c_void_p, c_void_p)
        MvCamCtrldll.MV_CC_GetImageBuffer.restype = c_uint
        # C原型 MV_CAMCTRL_API int __stdcall MV_CC_HB_Decode  ( IN void *  handle,  IN OUT MV_CC_HB_DECODE_PARAM *  pstDecodeParam )
